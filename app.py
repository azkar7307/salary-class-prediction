...
def prediction_data():
    ...
    if result == 0:
            return render_template(f'results.html', final_results = 'Your Yearly Income is Less than or Equal to 50k:{result}')
    elif result == 1:
            return render_template(f'results.html', final_results = 'Your Yearly Income is more than or Equal to 50k:{result}')
...
#         return "Excuted in exception part"
# if __name__ == '__main__':
#     app.run(debug=True)